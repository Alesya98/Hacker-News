...
export const NewsCard = ({ cardInfo }: CardProps) => {
    ...
    return (
        <Card className="card"
            hoverable
                style={{ marginBottom: '16', borderRadius: 12, transition: 'all 0.3s ease-in-out', border: '2px solid #f0f0f0', padding: '20px 24px', background: 'rgba(255, 255, 255, 0.85)', }}
            onClick={handeleClick}>
            <Title level={5} style={{marginBottom: 12, fontWeight:'500'}}>{cardInfo.title}</Title>
