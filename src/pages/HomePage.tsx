...
export const HomePage = () => {
  ...
  <LoadingOutlined style={{ fontSize: 48, color: "#722ed1" }} spin />
    ...
    return (
        <Layout style={{ padding: '0 50px', background: 'linear-gradient(135deg, #91caff, #d3adf7, #ffadd2', width: '100%', minHeight: '100vh' }}>
            <Content style={{maxWidth: 1400, margin: '0 auto', width: '100%', display:'flex', alignItems:'center', justifyContent: 'center', flexDirection:'column'}}>
